...
import 'package:custom_lint/src/cli_logger.dart';
import 'package:custom_lint/src/output/output_format.dart';
import 'package:custom_lint/src/output/render_lints.dart';
...
Future<void> _runServer(
  ...
  await CustomLintServer.runZoned(() => customLintServer, () async {
    ...
    try {
      ...
      final log = CliLogger();
      final progress = format == OutputFormatEnum.json ? null : log.progress('Analyzing');
