...
class JsonOutputFormat implements OutputFormat {
  @override
  void render({required Iterable<AnalysisError> errors, required Logger log}) {
  ...
  Map<String, Object?> _location({required String file, required Map<String, Object?> range}) {
    return {'file': file, 'range': range};
  }

  Map<String, Object?> _position({int? offset, int? line, int? column}) {
