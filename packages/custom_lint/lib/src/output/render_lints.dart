...
import 'package:custom_lint/src/output/default_output_format.dart';
import 'package:custom_lint/src/output/json_output_format.dart';
...
void renderLints(
  ...
  errors = errors.sorted((a, b) {
    ...
    final fileCompare = a.location.relativePath.compareTo(b.location.relativePath);
  ...
  outputFormat.render(errors: errors, log: log);
