...
typedef HandleAnalysisGetNavigation<R> = R Function(AnalysisGetNavigationParams parameters);

/// Handle an 'analysis.handleWatchEvents' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleAnalysisHandleWatchEvents<R> = R Function(AnalysisHandleWatchEventsParams parameters);

/// Handle an 'analysis.setContextRoots' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleAnalysisSetContextRoots<R> = R Function(AnalysisSetContextRootsParams parameters);

/// Handle an 'analysis.setPriorityFiles' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleAnalysisSetPriorityFiles<R> = R Function(AnalysisSetPriorityFilesParams parameters);

/// Handle an 'analysis.setSubscriptions' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleAnalysisSetSubscriptions<R> = R Function(AnalysisSetSubscriptionsParams parameters);

/// Handle an 'analysis.updateContent' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleAnalysisUpdateContent<R> = R Function(AnalysisUpdateContentParams parameters);

/// Handle a 'completion.getSuggestions' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleCompletionGetSuggestions<R> = R Function(CompletionGetSuggestionsParams parameters);

/// Handle an 'edit.getAssists' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleEditGetAssists<R> = R Function(EditGetAssistsParams parameters);
...
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleEditGetAvailableRefactorings<R> =
    R Function(EditGetAvailableRefactoringsParams parameters);

/// Handle an 'edit.getFixes' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleEditGetFixes<R> = R Function(EditGetFixesParams parameters);

/// Handle an 'edit.getRefactoring' request.
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandleEditGetRefactoring<R> = R Function(EditGetRefactoringParams parameters);
...
///
/// Throw a [RequestFailure] if the request could not be handled.
typedef HandlePluginVersionCheck<R> = R Function(PluginVersionCheckParams parameters);
